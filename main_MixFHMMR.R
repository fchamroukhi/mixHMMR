...
library(R.matlab)
data = readMat("simulated_data.mat")
...
## source files ##
debugSource("learn_MixFHMMR_EM.R")
debugSource("designmatrix.R")
debugSource("init_MixFHMMR.R")
debugSource("myKmeans.R")
debugSource("normalize.R")
