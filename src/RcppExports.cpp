...
RcppExport SEXP _mixHMMR_forwardsBackwards(SEXP priorSEXP, SEXP transmatSEXP, SEXP f_tkSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_mixHMMR_forwardsBackwards", (DL_FUNC) &_mixHMMR_forwardsBackwards, 3},
    {NULL, NULL, 0}
};
